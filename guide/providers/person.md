...
Faker.profile("username","name","sex","address","mail","birthdate","job","company","residence","current_location","blood_group","website")
...
Faker.simple_profile("username","name","sex","address","mail","birthdate")
...
Faker.user_profile((Faker.user_name(),Faker.first_name(),rand(["M","F"]),Faker.address(),Faker.free_email(),Faker.date(),Faker.job(),Faker.company(),Faker.address(),string(Faker.latitude(), Faker.longitude()),Faker.blood_type(),Faker.url()))
